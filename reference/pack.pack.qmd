...
pack.pack(
    ...
    title='App',
    output_dir='docs',
    stylesheet_version='0.77.0',
    js_bundle_version='0.76.0',
)
```
...
| requirements | str or list of str | Either:   - Path to a ``requirements.txt`` file (str), or   - A list of required Python packages (list of str). | _required_ |
